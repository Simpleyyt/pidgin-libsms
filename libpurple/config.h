...
/* configure arguments */
#define CONFIG_ARGS " '--disable-gtkui' '--disable-gstreamer' '--disable-vv' '--disable-idn' '--disable-meanwhile' '--disable-avahi' '--disable-dbus' '--disable-perl' '--disable-nss' '--disable-gnutls' '--disable-tcl'"
...
#define PACKAGE_STRING "pidgin 2.10.7"
